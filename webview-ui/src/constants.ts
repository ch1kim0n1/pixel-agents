...
export const IDLE_FRAME_DURATION_SEC = 0.55
export const IDLE_BREATHE_CYCLE_SEC = 2.8
export const IDLE_BOB_AMPLITUDE_PX = 0.45
export const TYPE_BOB_AMPLITUDE_PX = 0.55
export const WALK_BOB_AMPLITUDE_PX = 1.15
export const WALK_SWAY_AMPLITUDE_PX = 0.55
export const WANDER_PAUSE_MIN_SEC = 2.0
export const WANDER_PAUSE_MAX_SEC = 20.0
export const WANDER_MOVES_BEFORE_REST_MIN = 3
export const WANDER_MOVES_BEFORE_REST_MAX = 6
export const SEAT_REST_MIN_SEC = 24.0
export const SEAT_REST_MAX_SEC = 52.0
export const WORK_POSE_MIN_SEC = 0.9
export const WORK_POSE_MAX_SEC = 2.2
export const THINK_POSE_MIN_SEC = 0.35
export const THINK_POSE_MAX_SEC = 0.85
export const SOCIAL_GLANCE_MIN_SEC = 2.2
export const SOCIAL_GLANCE_MAX_SEC = 5.4
export const SOCIAL_GLANCE_DURATION_MIN_SEC = 0.55
export const SOCIAL_GLANCE_DURATION_MAX_SEC = 1.35
export const SOCIAL_NEARBY_RADIUS_TILES = 4
export const SOCIAL_BUBBLE_RADIUS_TILES = 6
